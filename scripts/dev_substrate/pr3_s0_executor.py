...
def main() -> None:
    ...
    surface_map = {
        ...
        "required_metric_surfaces": [
            ...
            {"metric_id": "consumer_lag", "surface": "MSK_CONSUMER_LAG", "source": "PR3_POLICY_PIN"},
            {"metric_id": "checkpoint_health", "surface": "FLINK_CHECKPOINT_METRICS", "source": "PR3_POLICY_PIN"},
