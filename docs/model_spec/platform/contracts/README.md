...
## Platform-native contracts (Dev-min evidence bundle, v0)
These live under:
`docs/model_spec/platform/contracts/dev_min/`

- `run_header.v0.schema.yaml`
- `ingress_receipt_summary.v0.schema.yaml`
- `audit_summary.v0.schema.yaml`
- `replay_anchor_summary.v0.schema.yaml`
- `metrics_anomaly_reconciliation_snapshot.v0.schema.yaml`
