...
- Phase 5.2 (CaseTrigger service + CM intake boundary): implementation-active (Phase 1+2+3+4+5 complete on 2026-02-09; CaseTrigger suite `36 passed`; next gate `5.2.G` CM intake integration).
