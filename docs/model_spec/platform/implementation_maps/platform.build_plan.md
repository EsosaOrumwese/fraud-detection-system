...
- Phase 6 (Learning & Registry plane): active (`6.2` OFS dataset-build corridor closure is complete; `6.3` MF train/eval/publish is in progress with Phases 1..6 complete; `6.6/6.7` remain mandatory closure gates before plane completion).
...
- Next active platform phase: Phase 6.3 (MF train/eval/publish corridor, Phase 7 next).
