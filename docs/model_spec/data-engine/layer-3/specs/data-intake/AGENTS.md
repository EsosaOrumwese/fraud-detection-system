# AGENTS.md - Data-Intake Router (Layer-3)
_As of 2025-12-31_

Use this router when authoring, acquiring, or deriving any intake artefacts for Layer-3 segments (6A-6B).

---

## 0) Scope (binding)
- Layer-3 segments: 6A, 6B.
...
2. Layer-3 intake guides in this folder
3. Layer-3 contracts:
   - `docs/model_spec/data-engine/layer-3/specs/contracts/<SEG>/*`
4. Layer-3 expanded specs (state-flow):
...
1) Layer evidence file (one per layer):
   - `docs/model_spec/data-engine/layer-3/specs/data-intake/evidence.md`
