...
- `s1_arrival_entities_6B` — Seeded enrichment of 5B arrival events with Layer-3 entity keys and posture references.
- `s1_session_index_6B` — Session/window index for grouping arrivals into higher level flows prior to S2.
