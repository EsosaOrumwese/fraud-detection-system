...
- `s5_party_fraud_roles_6A` — Fraud-posture assignments for parties (roles, reasons, evidence hashes).
- `s5_account_fraud_roles_6A` — Fraud-posture assignments for accounts.
- `s5_merchant_fraud_roles_6A` — Fraud-posture assignments for merchants.
- `s5_device_fraud_roles_6A` — Fraud-posture assignments for devices.
- `s5_ip_fraud_roles_6A` — Fraud-posture assignments for IPs/endpoints.
