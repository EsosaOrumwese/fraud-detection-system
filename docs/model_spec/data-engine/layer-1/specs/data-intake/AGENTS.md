# AGENTS.md - Data-Intake Router (Layer-1)
_As of 2025-12-31_

Use this router when authoring, acquiring, or deriving any intake artefacts for Layer-1 segments (1A-3B).

---

## 0) Scope (binding)
- Layer-1 segments: 1A, 1B, 2A, 2B, 3A, 3B.
...
2. Layer-1 intake guides in this folder
3. Layer-1 contracts:
   - `docs/model_spec/data-engine/layer-1/specs/contracts/<SEG>/*`
4. Layer-1 expanded specs (state-flow):
...
5. Note: 1A and 1B intake live under the 1A intake folder; read both 1A and 1B expanded specs before ordering guides.
...
1) Layer evidence file (one per layer):
   - `docs/model_spec/data-engine/layer-1/specs/data-intake/evidence.md`
