...
> Source of truth: `/mnt/data/3rd-updated-expansion.applied.vfinal.txt`. This file is a **faithful, code‑agnostic transcription** of S0’s per‑section routines. It preserves your algorithms exactly, but imposes consistent **placement and formatting** so implementers can read in order without guesswork.  
