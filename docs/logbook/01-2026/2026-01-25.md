...
* 11:27pm
  ...
  - Ran `make platform-ig-ready-once` with local profile time budget; pull completed as PARTIAL with `TIME_BUDGET_EXCEEDED` on output `arrival_events_5B` (status saved under runs/fraud-platform/ig/pull_runs/run_id=40dfb540e134f8bb8eb3585da3aeee7a.json). Process was stopped after the 10-minute cap.
