...
* 08:27am
  - Ran a fresh parity run to demonstrate EB visibility: reset streams, SR READY published, WSP streamed 20 events, platform.log shows `IG published to EB ...`, and `runs/fraud-platform/<run_id>/eb/eb.log` contains EB publish diagnostics.
