...
* 8:31pm
  - Mitigated lease token exposure: removed tracked lease token file, ignored `artefacts/fraud-platform/sr/index/`, added README + runtime warning about sensitive SR runtime artifacts.
