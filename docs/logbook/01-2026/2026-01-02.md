...
* 7:04pm
   - Increased 1A S2 corridor CUSUM threshold to 90.0 (from 60.0) after observing `cusum_max~80.7`; kept `reference_k=0.45`, bumped policy semver to `1.3.1`, and updated policy date (`config/policy/validation_policy.yaml`).
