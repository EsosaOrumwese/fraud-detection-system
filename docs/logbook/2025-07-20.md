...
* 9:45pm
  * Still on 1B: Append Governed Artefact Registry to assumptions
    * Add a fully enumerated “Governed Artefact Registry” table at end of assumptions_1B, listing each spatial and policy artefact (filename pattern, role, semver & digest fields) so that CI and auditors have a single source of truth for all governed inputs.

* 11:00pm
  * Moved to subsegment 2A: Deriving the civil time zone