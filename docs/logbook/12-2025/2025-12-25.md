...
* 5:50am
   - Added `config/layer1/1A/ingress/transaction_schema_merchant_ids.bootstrap.yaml` and registered it in `docs/model_spec/data-engine/layer-1/specs/contracts/1A/artefact_registry_1A.yaml` (including dependency wiring for `transaction_schema_merchant_ids`).
...
* 6:41pm
   - Added data-intake guides for segment 2A (first commit introducing guide files).
...
* 11:14pm
   - Added data-intake guides for segment 2B (first commit introducing guide files).
...
* 11:34pm
   - Updated `docs/model_spec/data-engine/layer-1/specs/data-intake/2B/alias_layout_policy_v1_authoring-guide.md` to adopt inventory-only digest posture (remove in-file `sha256_hex`, update digest law, example, and checklist).
   - Clarified in `docs/model_spec/data-engine/layer-1/specs/data-intake/2B/route_rng_policy_v1_authoring-guide.md` that `parameter_hash` is required at runtime with no fallback keying.


* 11:56pm
   - Updated `docs/model_spec/data-engine/layer-1/specs/data-intake/2B/route_rng_policy_v1_authoring-guide.md` to remove in-file `sha256_hex` and adopt inventory-side digest law, with updated example and acceptance checklist.
