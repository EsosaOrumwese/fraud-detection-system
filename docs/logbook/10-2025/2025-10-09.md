...
* 7:48am:
   ...
   - Materialised a real run under `artefacts/training/1A/hurdle_sim/simulation_version=2025-10-09/seed=9248923/20251009T120000Z/` and published the coefficients at `config/models/hurdle/exports/version=2025-10-09/20251009T120000Z/` (`hurdle_coefficients.yaml`, `nb_dispersion_coefficients.yaml`).
...
* 8:36am:
   - added `config/policy/crossborder_hyperparams.yaml` with a simple synthetic ladder:
      - Default `allow`.
   ...
   - Authored config/policy/crossborder_hyperparams.yaml with a synthetic, deterministic ladder that denies high-risk CNP MCCs, special-cases travel MCCs, whitelists CP traffic across the synthetic EEA subset, and defaults to allow.
...
* 9:32am:
   ...
   - Authored config/policy/s3.rule_ladder.yaml with a deterministic synthetic ladder:
