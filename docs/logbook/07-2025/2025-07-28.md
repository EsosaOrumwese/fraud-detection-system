...
* 6:12pm
  * Rewrote the `governing_artefacts` for subsegment 1A and 1B to fully capture ALL the artefacts in their respective narratives
  * Formed a machine-readable yaml file from both docs. 