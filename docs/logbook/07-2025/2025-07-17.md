...
* 12:00pm
  * Added the detailed deep dive of the narrative in `docs/references/[DATA-GEN]_generator_revamp_for_SD_02.md` to `docs/references/[DATA-GEN]_generator_revamp_proof_of_concept.md`
    * It is from these documents and assumptions which I'll upload later that I'll make the detailed specifications from.
