...
* 10:59am
  * Fix the critical issues in state-0 L0 pseudocode doc

* 11:23am
  * Close the high issues and add invariant header to the L0 pseudo-doc

* 11:52am
  * close the medium issues in state-0 L0 pseudo-doc

* 1:34pm
  * closed the low issues in state-0 L0

* 2:42pm
  * added fleshed out I/O shims to the L0 doc for state-0

* 5:33pm
  * Attempted removing the obscure function methods or definitions in the s0-L0 doc