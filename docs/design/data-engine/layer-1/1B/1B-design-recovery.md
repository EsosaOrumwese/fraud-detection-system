Segment `1B` design recovery

These Mermaid flowcharts replace the deleted DAGs for `1B`.
...
So these charts aim to convey actual `1B` design, not just the earliest restrictive spec shape.
