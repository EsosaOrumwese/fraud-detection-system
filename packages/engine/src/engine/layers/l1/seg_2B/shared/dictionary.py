"""Dataset dictionary helpers for Segment 2B."""
...
def default_dictionary_path() -> Path:
    """Return the canonical dictionary path for Segment 2B."""

    repo_root = _discover_repo_root()
    return repo_root / "contracts" / "dataset_dictionary" / "l1" / "seg_2B" / "layer1.2B.yaml"
...
def get_dataset_entry(
    ...
    raise err(
        "E_DICTIONARY_RESOLUTION_FAILED",
        f"dataset '{dataset_id}' not present in the Segment 2B dictionary",
    )
