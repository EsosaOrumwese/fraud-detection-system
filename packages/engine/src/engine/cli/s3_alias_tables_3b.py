"""CLI for Segment 3B S3 alias tables."""
...
from engine.layers.l1.seg_3B.s3_alias_tables.runner import run_s3


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 3B S3 alias tables.")
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_3B.s3_alias_tables.cli")
    ...
    logger.info(
        "S3 3B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
