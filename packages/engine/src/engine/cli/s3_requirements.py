"""CLI for Segment 1B S3 requirements."""
...
from engine.layers.l1.seg_1B.s3_requirements.runner import run_s3


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 1B S3 requirements.")
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_1B.s3_requirements.cli")
    ...
    logger.info(
        "S3 1B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s s3_requirements=%s run_report=%s",
        result.run_id,
