"""CLI for Segment 3B S5 validation bundle."""
...
from engine.layers.l1.seg_3B.s5_validation_bundle.runner import run_s5


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 3B S5 validation bundle.")
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_3B.s5_validation_bundle.cli")
    ...
    logger.info(
        "S5 3B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
