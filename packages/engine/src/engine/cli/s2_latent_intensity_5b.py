"""CLI for Segment 5B S2 latent intensity fields."""
...
from engine.layers.l2.seg_5B.s2_latent_intensity.runner import run_s2


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 5B S2 latent intensity fields.")
...
def main() -> None:
    logger = get_logger("engine.layers.l2.seg_5B.s2_latent_intensity.cli")
    ...
    logger.info(
        "S2 5B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
