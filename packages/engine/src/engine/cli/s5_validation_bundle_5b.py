"""CLI for Segment 5B S5 validation bundle."""
...
from engine.layers.l2.seg_5B.s5_validation_bundle.runner import run_s5


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 5B S5 validation bundle.")
...
def main() -> None:
    logger = get_logger("engine.layers.l2.seg_5B.s5_validation_bundle.cli")
    ...
    logger.info(
        "S5 5B complete: run_id=%s manifest_fingerprint=%s bundle_root=%s",
        result.run_id,
