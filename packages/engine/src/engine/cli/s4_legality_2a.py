"""CLI for Segment 2A S4 legality report."""
...
from engine.layers.l1.seg_2A.s4_legality.runner import run_s4


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 2A S4 legality report.")
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_2A.s4_legality.cli")
    ...
    logger.info(
        "S4 2A complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
