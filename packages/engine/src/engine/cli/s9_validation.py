"""CLI for Segment 1A S9 validation bundle."""
...
from engine.layers.l1.seg_1A.s9_validation.runner import run_s9


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run Segment 1A S9 replay validation."
    )
    parser.add_argument(
        "--contracts-layout",
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_1A.s9_validation.cli")
