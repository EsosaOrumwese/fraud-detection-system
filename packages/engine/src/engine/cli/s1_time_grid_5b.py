"""CLI for Segment 5B S1 time grid + grouping."""
...
from engine.layers.l2.seg_5B.s1_time_grid.runner import run_s1


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 5B S1 time grid + grouping.")
...
def main() -> None:
    logger = get_logger("engine.layers.l2.seg_5B.s1_time_grid.cli")
    ...
    logger.info(
        "S1 5B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
