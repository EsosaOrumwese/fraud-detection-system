...
from engine.layers.l1.seg_2B.s5_router.runner import run_s5


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 2B S5 router.")
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_2B.s5_router.cli")
    ...
    logger.info(
        "S5 2B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
