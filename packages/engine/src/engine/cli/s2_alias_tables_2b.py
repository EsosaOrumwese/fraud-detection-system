"""CLI for Segment 2B S2 alias tables."""
...
from engine.layers.l1.seg_2B.s2_alias_tables.runner import run_s2


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 2B S2 alias tables.")
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_2B.s2_alias_tables.cli")
    ...
    logger.info(
        "S2 2B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
