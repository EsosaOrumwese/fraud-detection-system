"""CLI for Segment 2B S8 validation bundle."""
...
from engine.layers.l1.seg_2B.s8_validation_bundle.runner import run_s8


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 2B S8 validation bundle.")
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_2B.s8_validation_bundle.cli")
    ...
    logger.info(
        "S8 2B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s bundle=%s",
        result.run_id,
