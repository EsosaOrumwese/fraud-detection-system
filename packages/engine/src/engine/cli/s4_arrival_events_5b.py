"""CLI for Segment 5B S4 arrival events."""
...
from engine.layers.l2.seg_5B.s4_arrival_events.runner import run_s4
...
def main() -> None:
    logger = get_logger("engine.layers.l2.seg_5B.s4_arrival_events.cli")
    ...
    logger.info(
        "S4 5B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
