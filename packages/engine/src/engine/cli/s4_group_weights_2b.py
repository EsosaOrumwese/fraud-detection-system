"""CLI for Segment 2B S4 group weights."""
...
from engine.layers.l1.seg_2B.s4_group_weights.runner import run_s4


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 2B S4 group weights.")
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_2B.s4_group_weights.cli")
    ...
    logger.info(
        "S4 2B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
