"""CLI for Segment 2B S6 edge router."""
...
from engine.layers.l1.seg_2B.s6_edge_router.runner import run_s6


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 2B S6 edge router.")
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_2B.s6_edge_router.cli")
    ...
    logger.info(
        "S6 2B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
