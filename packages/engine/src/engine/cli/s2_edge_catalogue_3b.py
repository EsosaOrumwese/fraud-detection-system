"""CLI for Segment 3B S2 edge catalogue."""
...
from engine.layers.l1.seg_3B.s2_edge_catalogue.runner import run_s2


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 3B S2 edge catalogue.")
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_3B.s2_edge_catalogue.cli")
    ...
    logger.info(
        "S2 3B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
