"""CLI for Segment 2B S3 day effects."""
...
from engine.layers.l1.seg_2B.s3_day_effects.runner import run_s3


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 2B S3 day effects.")
...
def main() -> None:
    logger = get_logger("engine.layers.l1.seg_2B.s3_day_effects.cli")
    ...
    logger.info(
        "S3 2B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
