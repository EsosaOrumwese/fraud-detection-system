"""CLI for Segment 6B S5 validation gate."""
...
from engine.layers.l3.seg_6B.s5_validation_gate.runner import run_s5


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 6B S5 validation gate.")
...
def main() -> None:
    logger = get_logger("engine.layers.l3.seg_6B.s5_validation_gate.cli")
    ...
    logger.info(
        "S5 6B complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s report=%s",
        result.run_id,
