"""CLI for Segment 5A S1 demand classification."""
...
from engine.layers.l2.seg_5A.s1_demand_classification.runner import run_s1


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Segment 5A S1 demand classification.")
...
def main() -> None:
    logger = get_logger("engine.layers.l2.seg_5A.s1_demand_classification.cli")
    ...
    logger.info(
        "S1 5A complete: run_id=%s parameter_hash=%s manifest_fingerprint=%s",
        result.run_id,
