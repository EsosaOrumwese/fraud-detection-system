"""CLI runner for Segment 1B (S0 -> S2)."""
...
from engine.layers.l1.seg_1B import S2TileWeightsValidator, S2ValidatorConfig
...
def main(argv: list[str] | None = None) -> int:
    ...
    run_parser = subparsers.add_parser("run", help="Execute Segment 1B states S0-S2")
