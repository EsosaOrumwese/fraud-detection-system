...
ENGINE_5B_S4_SHARED_MAPS ?= 1
ENGINE_5B_S4_COMPILED_KERNEL ?= 1
SEG1A_S0_SEED ?=
...
SEG5B_S4_CMD = \
	...
	ENGINE_5B_S4_WORKERS=$(ENGINE_5B_S4_WORKERS) \
	ENGINE_5B_S4_INFLIGHT_BATCHES=$(ENGINE_5B_S4_INFLIGHT_BATCHES) \
	ENGINE_5B_S4_EVENT_BUFFER=$(ENGINE_5B_S4_EVENT_BUFFER) \
	ENGINE_5B_S4_VALIDATE_EVENTS_LIMIT=$(ENGINE_5B_S4_VALIDATE_EVENTS_LIMIT) \
	ENGINE_5B_S4_OUTPUT_BUFFER_ROWS=$(ENGINE_5B_S4_OUTPUT_BUFFER_ROWS) \
	ENGINE_5B_S4_SHARED_MAPS=$(ENGINE_5B_S4_SHARED_MAPS) \
	ENGINE_5B_S4_COMPILED_KERNEL=$(ENGINE_5B_S4_COMPILED_KERNEL) \
